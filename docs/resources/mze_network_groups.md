...
page_title: "fmc_mze_network_groups Resource - terraform-provider-fmc"
subcategory: "Objects"
description: |-
...
# fmc_mze_network_groups (Resource)
...
- `network_groups` (Set of String) Set of names (not Ids) of child Network Groups. The names must be defined in the same instance of `fmc_mze_network_groups` resource.
